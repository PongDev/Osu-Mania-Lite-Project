...
public class Menu extends HBox {
	...
	public Menu(Stage primaryStage, BeatMap beatMap, NoteTiles noteTiles, KeyPressTiles keyPressTiles) {
		...
		playButton.setOnAction(e -> {
			if (this.scoreProcessor != null) {
				this.scoreProcessor.interrupt();
			}
			this.scoreProcessor = new ScoreProcessor(this.beatMap, this.keyPressTiles, this.hitScoreLabel,
					this.missScoreLabel);

			if (this.gameThread != null) {
				this.gameThread.interrupt();
			}
			this.gameThread = new GameThread(this.beatMap, this.noteTiles);
	...
	public GameThread getCurrentGameThread() {
		return gameThread;
	}
}
